...
Username = Annotated[
    str,
    StringConstraints(strip_whitespace=True, min_length=3, max_length=32, pattern=r"^[a-zA-Z0-9_]+$"),
    Field(description="Unique username", examples=["john_doe"]),
]
Password = Annotated[
    SecretStr,
    Field(min_length=8, max_length=128, description="Password must be at least 8 characters long and less than 128 characters", examples=["StrongPass123!"]),
]
