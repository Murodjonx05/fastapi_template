...
def _match_or_unknown(
    ...
    return (
        kind if _marker_matches(markers, message) else ConstraintViolationKind.UNKNOWN
    )
...
def get_constraint_violation_kind(
    ...
    *,
    ...
    mysql_kind = _classify_by_mapping(
        markers, mysql_code, _MYSQL_ERROR_CODES, msg_lower
    )
